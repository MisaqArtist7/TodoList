      ...
      <div className='primaryShadow bg-[#151515] border border-black rounded-3xl text-white z-50 w-[369px]'>
        ...
        <div className='px-4 py-7 overflow-hidden flex flex-col justify-center gap-4'>
          ...
          <div className='flex flex-col justify-center gap-2'>
            ...
            {todos.map((todo) => (
              <>
                <div className={`${todo.hasDone ? 'text-[#7A7777]' : ''} bg-[#201F1F] p-3 rounded-lg flex items-center justify-between`}>
                  ...
                  <div className="flex items-center gap-1 pointer-events-none">
                    ...
                    <span className={`${todo.hasDone ? 'line-through' : ''}`}>Do exercise</span>
                  </div>
