              ...
              <React.Fragment key={todo.id}>
                <div className={`${todo.hasDone ? 'text-[#7A7777]' : ''} select-none bg-[#201F1F] hover:bg-[#152C2B] p-3 rounded-lg flex items-center justify-between`}>
                  ...
                  <div className='flex items-center gap-1'>
                    ...
                    <svg onClick={()=> updateTodo(todo)} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 cursor-pointer">
        ...
        <>
          ...
          <div className='z-50 bg-black/80 flex-row-center min-h-screen absolute right-0 left-0 top-0 bottom-0'>
            ...
            <div className='primaryShadow bg-[#201F1F] w-[90%] sm:w-[50%] lg:w-[30%] rounded-md text-white'>
              ...
              {/* Modal Header */}
              <div className='flex items-center justify-between bg-[#152C2B] px-3 py-4 rounded-t-md'>
                {/* Title */}
              ...
              <div className='px-3 py-4'>
                <form onSubmit={submitted} className='flex-col-center gap-2'>
                  <input value={inputValue} onChange={inputHandler} type="text" placeholder={editingTodoId !== null ? "Edit your todo..." : "Add a new todo..."} className='border-b w-[70%] px-2 py-1 rounded' />
                  <button type="submit" className='border border-gray-600 px-11 py-2 mt-4 rounded-lg secoundaryShadow hover:bg-[#152C2B]' >
